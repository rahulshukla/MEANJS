...
MAINTAINER Rahul Shukla <rahul.shukla@manipalglobal.com>
...
# CHeck using mongo-shell if mongo is running , if not Start mongo using ENTRYPOINT of Programming Environment existing image. 
